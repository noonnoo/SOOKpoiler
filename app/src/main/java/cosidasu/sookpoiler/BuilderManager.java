...
public class BuilderManager {
    ...
    private static int[] imageResources = new int[]{
            R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it, R.drawable.it
    ...
    static HamButton.Builder getHamButtonBuilder() {
        return new HamButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(R.string.todo_title)
                .subNormalTextRes(R.string.todo);
    }
